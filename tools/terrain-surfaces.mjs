  ...
  JSON.stringify(
    {
      ...
      purpose:
        'Approved illustrated texture samples; illustrated tiles keep the native-resolution centre window, rock the whole image. Generated by tools/terrain-surfaces.mjs',
    },
    null,
    2,
  ) + '\n',
